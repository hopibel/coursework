 ...
 * The original example simulated coin flips. This version should be able
 * to handle anything that implements the Game interface
 */
...
//System.out.println(newNode==null);
	...
	public void expand(List<? extends State> moves) {
		...
		for(int i = 0; i < actions; ++i) {
			children.add(new MCTSNode(moves.get(i), C));
		}
	}
